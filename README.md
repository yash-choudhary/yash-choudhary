...
<b aligh="left">Wednesday, 11 October</b>
...
- ⚡ Fun fact: **"255 is the largest values that can be assigned to elements in the 24-bit RGB color model, since each color channel is allotted eight bits."**
